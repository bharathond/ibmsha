...
function LoginComponent() {
    ...
    const formik = useFormik({
        ...
        onSubmit: (values) => {
            console.log(values)
            let loginData = {'username' : values.userName, 'password' : values.password, 'role' : 'user'};
            try{
                                ...
                                <div className="login-container">
                                    ...
                                    <div className="form-container">
                                        ...
                                        <form onSubmit={formik.handleSubmit}>
                                            <input type="text" name='userName' onBlur={formik.handleBlur} value={formik.values.userName} onChange={formik.handleChange} placeholder="USERNAME" className="form-control form-control-lg" id="userName" />
                                            { formik.touched.userName ? <span>{formik.errors.userName}</span> : null }
                                            <input type="password" name='password' onBlur={formik.handleBlur} value={formik.values.password} id="password" placeholder="PASSWORD" onChange={formik.handleChange} className="form-control form-control-lg" />
                                        ...
                                        <div class="register-forget opacity">
                                            ...
                                            <Link className='nav-link' to='/user/register'>FORGOT PASSWORD</Link>
                                        </div>
                                    </div>
